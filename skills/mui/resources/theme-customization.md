...
const themeWithLayers = createTheme({
...
**Note:** Enabling `modularCssLayers` changes specificity behavior. Test thoroughly after enabling.

## Native Color Support (v9+)

Use `InitColorSchemeScript` for SSR-safe color scheme initialization:

```typescript
import { InitColorSchemeScript } from '@mui/material';

// In your HTML <head> or root layout
<html>
  <head>
